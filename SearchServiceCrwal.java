...
property = { 
		Constants.SERVICE_DESCRIPTION + "=Query servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_GET, 
		"sling.servlet.paths=" + "/bin/querybuilder" 
		})
public class SearchServiceCrwal extends SlingSafeMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		try{
			...
			while ( nodeIter.hasNext() ) {
				    ...
				    response.getWriter().write("<a href="+node.getPath()+".html"+">"+node.getPath()+".html"+"</a>"+"<br>"); 
